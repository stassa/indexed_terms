...
or negative, allowing slicing from the start or end of an iterm. 
...
Endpoints may also be given in descending order to obtain the selected arguments in reverse
